...
\begin{figure}[htb]
    ...
    \caption{\textit{Evolution of the root mean square velocity as a function of time for 
    different global mesh refinements when we computed the Van Keken benchmark with the VOF 
    interface tracking algorithm.
    Compare to Figure~\ref{fig:vk-2}.}}
    \label{fig:vof-vk-1}
\end{figure}
