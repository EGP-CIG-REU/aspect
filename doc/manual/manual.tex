...
Note that, other than for the case of 5 levels of global refinement, the curves for the RMS velocities for $6, 7, 8, 9$ levels of refinement are nearly indistinguishable.
