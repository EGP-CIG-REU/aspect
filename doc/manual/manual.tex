...
algorithm.
In fact, this problem is particularly is well-suited to the use of the VOF interface tracking 
algorithm, since it consists of two distinct, immiscible fluids and interface tracking 
...
at sub-grid scales over the duration of the problem.
Furthermore, since one of the primary aspects of interest in the computation is the form of the 
interface between the two fluids, one can examine the interface within individual cells or within regions consisting of groups of cells with the VOF method.
