...
namespace aspect
{
  ...
  namespace InclusionBenchmark
  {
    ...
    namespace AnalyticSolutions
    {
      ...
      /**
       * The exact solution for the EGPHVL benchmark, given the value
...
//TODO: should we make this a virtual function as well? where is it used?
    ...
    density (const double,
             ...
             const Point<dim> &p) const
    {
      // defined as given by EGP's notes including the constant background density
      return background_density*p[1]/2.0;
    }
    ...
    SolCxMaterial<dim>::declare_parameters (ParameterHandler &prm)
    {
      prm.enter_subsection("Material model");
      {
        ...
        {
//TODO: Remove all lines concerning "Viscosity jump"
          prm.declare_entry ("Viscosity jump", "1.0",
                             Patterns::Double (0),
                             "Viscosity in the right half of the domain.");
//TODO: Change the name to reference density
          prm.declare_entry ("Background density", "1",
                             Patterns::Double (0),
                             "Density value upon which the variation of this testcase "
                             "is overlaid. Since this reference density is constant "
    ...
    /**
      ...
      * benchmarks defined in EGP's notes
      */
    template <int dim>
